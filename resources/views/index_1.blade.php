        ...
        <div id="wrapper">
            <div id="scroller">
                @foreach($commodityBanners as $banner)
                    <div class="slide">
                        <img class="painting lunbo" src="{{$banner->img}}" />
                    </div>
                @endforeach
            </div>
        </div>
                ...
                success:function(res){
                    ...
                    for (var i = 0; i < data.length; i++) {
                        _temp += "<li onclick='gdetail("+data[i].id+")'>" +
                            "<img style='width: 100%' src='"+data[i].img+"' />" +
                            "<div class='priceDiv'>"+data[i].price+"<s>"+data[i].oprice+"</s></div>" +
                            "<div class='priceText'>"+data[i].remark+"</div>" +
                            "</li>";
                    }
                    $("#dataList").html(_temp);
                },
